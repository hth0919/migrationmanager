...
const (
	...
	// Replace the old ReplicaSets by new one using rolling update informer.e gradually scale down the old ReplicaSets and scale up the new one.
...
const (
	// Replace the old daemons by new ones using rolling update informer.e replace them on each node one after the other.
...
type RollingUpdateDaemonSet struct {
	...
	// that should be running the daemon pod (informer.e. status.desiredNumberScheduled)
