...
func (ssc *defaultStatefulSetControl) UpdateStatefulSet(set *ketiv1.StatefulSet, pods []*ketiv1.Pod) error {
...
func (ssc *defaultStatefulSetControl) ListRevisions(set *ketiv1.StatefulSet) ([]*ketiv1.ControllerRevision, error) {
...
func (ssc *defaultStatefulSetControl) AdoptOrphanRevisions(
	...
	revisions []*ketiv1.ControllerRevision) error {
...
func (ssc *defaultStatefulSetControl) truncateHistory(
	set *ketiv1.StatefulSet,
	pods []*ketiv1.Pod,
	revisions []*ketiv1.ControllerRevision,
	current *ketiv1.ControllerRevision,
	update *ketiv1.ControllerRevision) error {
	history := make([]*ketiv1.ControllerRevision, 0, len(revisions))
...
func (ssc *defaultStatefulSetControl) getStatefulSetRevisions(
	set *ketiv1.StatefulSet,
	revisions []*ketiv1.ControllerRevision) (*ketiv1.ControllerRevision, *ketiv1.ControllerRevision, int32, error) {
	var currentRevision, updateRevision *ketiv1.ControllerRevision
...
func (ssc *defaultStatefulSetControl) updateStatefulSet(
	set *ketiv1.StatefulSet,
	currentRevision *ketiv1.ControllerRevision,
	updateRevision *ketiv1.ControllerRevision,
	collisionCount int32,
	pods []*ketiv1.Pod) (*ketiv1.StatefulSetStatus, error) {
	...
	status := ketiv1.StatefulSetStatus{}
	...
	*status.CollisionCount = collisionCount
	...
	replicas := make([]*ketiv1.Pod, replicaCount)
	// slice that will contain all Pods such that set.Spec.Replicas <= getOrdinal(pod)
	condemned := make([]*ketiv1.Pod, 0, len(pods))
	unhealthy := 0
	firstUnhealthyOrdinal := math.MaxInt32
	var firstUnhealthyPod *ketiv1.Pod
	...
	if set.Spec.UpdateStrategy.Type == ketiv1.OnDeleteStatefulSetStrategyType {
		return &status, nil
	}
