...
func (m *PodControllerRefManager) ReleasePod(pod *v1.Pod) error {
	klog.Infof("patching pod %s_%s to remove its controllerRef to %s/%s:%s",
...
// returned.
func (m *ReplicaSetControllerRefManager) ClaimReplicaSets(sets []*v1.ReplicaSet) ([]*v1.ReplicaSet, error) {
	var claimed []*v1.ReplicaSet
	var errlist []error
	...
	adopt := func(obj metav1.Object) error {
		return m.AdoptReplicaSet(obj.(*v1.ReplicaSet))
	}
	release := func(obj metav1.Object) error {
		return m.ReleaseReplicaSet(obj.(*v1.ReplicaSet))
	}
...
func (m *ReplicaSetControllerRefManager) AdoptReplicaSet(rs *v1.ReplicaSet) error {
	if err := m.CanAdopt(); err != nil {
...
// It returns the error if the patching fails. 404 and 422 errors are ignored.
func (m *ReplicaSetControllerRefManager) ReleaseReplicaSet(replicaSet *v1.ReplicaSet) error {
	klog.Infof("patching ReplicaSet %s_%s to remove its controllerRef to %s/%s:%s",
...
// returned.
func (m *ControllerRevisionControllerRefManager) ClaimControllerRevisions(histories []*v1.ControllerRevision) ([]*v1.ControllerRevision, error) {
	...
	release := func(obj metav1.Object) error {
		return m.ReleaseControllerRevision(obj.(*v1.ControllerRevision))
	}
...
// the patching fails.
func (m *ControllerRevisionControllerRefManager) AdoptControllerRevision(history *v1.ControllerRevision) error {
	if err := m.CanAdopt(); err != nil {
...
// It returns the error if the patching fails. 404 and 422 errors are ignored.
func (m *ControllerRevisionControllerRefManager) ReleaseControllerRevision(history *v1.ControllerRevision) error {
	klog.Infof("patching ControllerRevision %s_%s to remove its controllerRef to %s/%s:%s",
